...
export default function Locations() {
  ...
  return (
    <section id="locations" className="py-24 px-6 bg-cream gsap-reveal" ref={ref}>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {locations.map((location) => (
            <motion.div
              ...
              className="bg-cream/80 rounded-2xl overflow-hidden border border-espresso/10 shadow-lg"
            >
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <MapPin className="w-5 h-5 text-warm-gold flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="text-charcoal font-medium">{location.address}</p>
                    <p className="text-mocha">{location.city}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Clock className="w-5 h-5 text-warm-gold flex-shrink-0 mt-0.5" />
                  <div>
                ...
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-warm-gold flex-shrink-0" />
                  <a
